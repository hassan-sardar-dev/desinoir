...
const Hero = () => {
  return (
    <div className="container mx-auto px-4 sm:px-8 lg:px-14">
      <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start py-8 lg:py-16">
        <div className="relative w-full lg:w-1/3 mb-8 lg:mb-0 text-center lg:text-left">
          <span
            className="text-4xl sm:text-5xl lg:text-7xl font-bold font-[arial] tracking-wider block"
