...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { id: 4, label: "UI Store", href: "/store" },
  ];
  ...
  return (
    <nav className="bg-transparent h-20 md:h-24 flex justify-between items-center   w-full px-6 md:px-28">
      ...
      <div
        className={`md:hidden absolute top-20 left-0 w-full bg-blue-900 p-4 flex flex-col space-y-4 text-white transition-all duration-300 ${
